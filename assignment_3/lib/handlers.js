...
Set client handlers.
*/
handlers.client = require('./client');
...
handlers._cards.delete = (data, callback) => {
    ...
    const cardId = typeof(data.queryString.cardId) == 'string' && data.queryString.cardId.trim().length == 40 ? data.queryString.cardId.trim() : false;
    if(cardId){
        //Read card data
